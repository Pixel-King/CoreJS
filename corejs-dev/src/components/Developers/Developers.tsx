            ...
            <div className='dev'>
                <div className='dev_text'>
                    ...
                    <div className='dev_text_text'>
                        ...
                        <p>Реализовано: аутентификация, авторизация, шифрование и хэширование, CSRF-защита, реалицаия паспорта JWT</p>
                        <p>Создал таблицу лидеров и личный профиль пользователя, авторизацию и регистрацию на фронте</p>
                    </div>
                </div>
